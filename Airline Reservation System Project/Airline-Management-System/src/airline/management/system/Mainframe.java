...
public class Mainframe extends JFrame{
	...
	add(NewLabel); 
        ...
        JLabel AirlineManagementSystem = new JLabel("Welcome To your Airline, Your home in the sky");
...
//	menuBar.add(Misc);
        JMenuItem ManageFlight=new JMenuItem("MANAGE_FLIGHT");
        AirlineSystem.add(ManageFlight);
	...
	ManageFlight.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ae){
                try {
                    new ManageFlight();
                } catch (Exception e) {
